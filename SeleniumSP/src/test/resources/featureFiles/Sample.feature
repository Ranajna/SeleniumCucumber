...
Feature: To perform Automation Assignments
  ...
  Scenario: To Sign and buy a T-shirt
    When user login to application as "Ranju" user
  ...
  Scenario: Update Personal Information   
    ...
    And user enters "Ranjana" user's "password" in "oldpassword" field
    And user clicks on "save"
    And user clicks on "myaccount"
    And user clicks on "personalinfo" 
   	And user compares expected value "autobot" actual value of element "firstname" 
		And user clicks on "signout" 